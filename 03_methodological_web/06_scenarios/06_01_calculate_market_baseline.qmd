...
#       dimensions, baseline metrics, saturation curves, conservation
...
fig_c1_saturation_curves <- import(
  here("..", "01_data", "02_processed", "web_resources",
       "06_01_s22_sub00_fig_c1_saturation_curves.rds"),
  trust = TRUE
)

tbl_c3_conservation_check <- import(
  here("..", "01_data", "02_processed", "web_resources",
       "06_01_s22_sub00_tbl_c3_conservation_check.rds"),
  trust = TRUE
)

tbl_c4_saturation_order <- import(
  here("..", "01_data", "02_processed", "web_resources",
       "06_01_s22_sub00_tbl_c4_saturation_order.rds"),
  trust = TRUE
)

fig_c5_saturation_after <- import(
  here("..", "01_data", "02_processed", "web_resources",
       "06_01_s22_sub00_fig_c5_saturation_after.rds"),
  trust = TRUE
)

tbl_c6_market_metrics_after <- import(
  here("..", "01_data", "02_processed", "web_resources",
       "06_01_s22_sub00_tbl_c6_market_metrics_after.rds"),
  trust = TRUE
)
...
min_coverage_after <- round(min(tbl_c6_market_metrics_after$coverage_after), 1)
max_coverage_gain  <- round(max(tbl_c6_market_metrics_after$coverage_change), 1)
```
...
df_saturation_points <- fig_c1_saturation_curves |>
...
ggplot() +
  ...
  geom_line(
    data = filter(fig_c1_saturation_curves, color_group == "Other"),
