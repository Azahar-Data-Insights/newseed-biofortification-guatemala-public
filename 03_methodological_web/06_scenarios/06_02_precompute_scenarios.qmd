...
description-meta: "Pre-computing the seed-by-subsidy scenario grid across departments and coverage levels so the dashboard aggregates instead of simulating live."
---
...
This formulation expresses adoption as a smooth conversion intensity per farmer. The conversion curves and their calibration are documented in the [Market Baseline Calculation](06_01_calculate_market_baseline.qmd#continuous-adoption-model) page, together with the [production coverage scale](06_01_calculate_market_baseline.qmd#production-coverage-scale) that associates each level with its internal adoption index.
