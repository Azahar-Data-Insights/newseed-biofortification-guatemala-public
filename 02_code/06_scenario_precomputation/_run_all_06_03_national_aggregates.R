...
# National Aggregates Precomputation (Step 06_03)
# ==============================================================================
#
...
#   - 06_03_{seed_suffix}_{subsidy_suffix}_{pathway}_national_scenarios.parquet
#
# Prerequisites:
...
#
# Note: 06_03 does NOT depend on 06_02. Both scripts read the same
...
#
# Usage:
#   source("02_code/06_scenario_precomputation/_run_all_06_03_national_aggregates.R")
#
# ==============================================================================
  ...
  tryCatch(
    {
      ...
      expected_parquet <- file.path(
        parquet_output_dir,
        paste0("06_03_", combo$seed_suffix, "_", combo$subsidy_suffix,
               "_", combo$pathway,
               "_national_scenarios.parquet")
      )
...
run_pipeline <- function() {
  ...
  qmd_input <- here(
    ...
    "06_03x_precompute_national_aggregates.qmd"
  )
  ...
  log_path <- file.path(log_dir, "06_03_national_aggregates_log.parquet")
  ...
  mirai_profile  <- "orchestrator_06_03"
  ...
  message("")
  message(strrep("=", 70))
  message("National Aggregates Pipeline (mirai) \u2014 Execution Summary")
  message(strrep("=", 70))
  ...
  notify_telegram(sprintf(
    "*06_03 National Aggregates* \u2014 pipeline finished\nRun ID: `%s`\nSuccesses: %d | Failures: %d\nTotal duration: %.1f sec",
